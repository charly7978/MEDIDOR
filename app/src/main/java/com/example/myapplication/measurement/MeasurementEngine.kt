...
class MeasurementEngine {
    ...
    fun measureAngle(point1: MeasurementPoint, vertex: MeasurementPoint, point2: MeasurementPoint): MeasurementResult {
    ...
    private fun calculateEuclideanDistance(point1: MeasurementPoint, point2: MeasurementPoint): Float {
    ...
    private fun calculateAngle(point1: MeasurementPoint, vertex: MeasurementPoint, point2: MeasurementPoint): Float {
        // Calcular vectores
    ...
    fun calculate3DDistance(point1: MeasurementPoint, point2: MeasurementPoint, depthMap: Array<Array<Float>>): MeasurementResult {
